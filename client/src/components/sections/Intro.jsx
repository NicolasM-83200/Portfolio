...
const Intro = () => {
  return (
    ...
    >
      <span className="animate-scale absolute bottom-0 left-1/2 size-[460px] -translate-x-1/2 translate-y-1/2 rounded-full bg-secondary md:-left-0 md:top-0 md:-translate-x-1/2 md:translate-y-1/2"></span>
      <div className="flex flex-col-reverse items-center gap-5 md:flex-row">
        <div className="basis-1/2 animate-trans-left self-center text-white">
          ...
          <p className="md:mt-6 md:text-left md:text-xl">
            <strong>
              Je suis passionné par l'innovation, la résolution de problèmes et
              la création d'expériences en ligne exceptionnelles.
            </strong>{" "}
            Mon portfolio reflète non seulement mes compétences techniques, mais
            aussi mon engagement envers l'excellence. Explorez mon travail pour
            découvrir comment je peux apporter une valeur ajoutée à votre
            projet.
          </p>
        </div>
